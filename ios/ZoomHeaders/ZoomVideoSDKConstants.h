...
typedef NS_ENUM(NSUInteger, ZoomVideoSDKPhoneFailedReason) {
    ...
    ZoomVideoSDKPhoneFailedReason_Busy,///<The telephone service is busy.
    ZoomVideoSDKPhoneFailedReason_Not_Available,///<The telephone is out of the service.
    ZoomVideoSDKPhoneFailedReason_User_Hangup,///<The user hangs up.
    ZoomVideoSDKPhoneFailedReason_Other_Fail,///<Other reasons.
    ZoomVideoSDKPhoneFailedReason_No_Answer,///<The telephone does not reply.
    ZoomVideoSDKPhoneFailedReason_Block_No_Host,///<Disable the function of international call-out before the host joins the session.
    ZoomVideoSDKPhoneFailedReason_Block_High_Rate,///<The call-out is blocked by the system due to the high cost.
    ZoomVideoSDKPhoneFailedReason_Block_Too_Frequent,///<All the invitees invited by the call should press the button one(1) to join the session. In case that many invitees do not press the button that leads to time out, the call invitation for this session shall be banned.
};
...
typedef NS_ENUM(NSUInteger, ZoomVideoSDKRecordingStatus) {
    ...
    ZoomVideoSDKRecordingStatus_Start,///The recording has started or resumed.
    ZoomVideoSDKRecordingStatus_Stop,///The recording has stopped.
    ZoomVideoSDKRecordingStatus_DiskFull,///Recording is unsuccessful due to not having enough storage space.Please try to:1.Free up space  2.Purchase more space
...
typedef NS_ENUM(NSUInteger,ZoomVideoSDKChatMsgDeleteBy)
{
    ...
    ZoomVideoSDKChatMsgDeleteBy_SELF,     /// Delete by self
    ZoomVideoSDKChatMsgDeleteBy_HOST,     /// Delete by host
    ZoomVideoSDKChatMsgDeleteBy_DLP,      /// Delete by dlp when the message goes against the host organization's compliance policies.
};
