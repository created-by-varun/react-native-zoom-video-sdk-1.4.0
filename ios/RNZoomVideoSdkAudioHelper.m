                  ...
                  withRejecter:(RCTPromiseRejectBlock)reject)
{
    dispatch_async(dispatch_get_main_queue(), ^{
        resolve(@([[self getAudioHelper] startAudio]));
    });
}
...
{
    dispatch_async(dispatch_get_main_queue(), ^{
        resolve(@([[self getAudioHelper] stopAudio]));
    });
}
                  ...
                  withRejecter:(RCTPromiseRejectBlock)reject)
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        resolve(@([[self getAudioHelper] muteAudio:user]));
    });
}
                  ...
                  withRejecter:(RCTPromiseRejectBlock)reject)
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ZoomVideoSDKUser *user = [RNZoomVideoSdkUser getUser:userId];
        resolve(@([[self getAudioHelper] unmuteAudio:user]));
    });
}
...
{
    dispatch_async(dispatch_get_main_queue(), ^{
       resolve(@([[self getAudioHelper] subscribe]));
    });
}
...
{
    dispatch_async(dispatch_get_main_queue(), ^{
       resolve(@([[self getAudioHelper] unSubscribe]));
    });
}
