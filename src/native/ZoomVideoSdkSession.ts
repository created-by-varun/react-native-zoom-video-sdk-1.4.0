...
export class ZoomVideoSdkSession implements ZoomVideoSdkSessionType {
  getSessionName = RNZoomVideoSdkSession.getSessionName;
  getSessionPassword = RNZoomVideoSdkSession.getSessionPassword;
  getSessionHostName = RNZoomVideoSdkSession.getSessionHostName;
