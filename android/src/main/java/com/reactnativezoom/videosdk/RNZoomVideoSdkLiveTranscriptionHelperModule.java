...
public class RNZoomVideoSdkLiveTranscriptionHelperModule extends ReactContextBaseJavaModule {
  ...
  public void startLiveTranscription(Promise promise) {
    reactContext.getCurrentActivity().runOnUiThread(new Runnable() {
      @Override
      public void run() {
        promise.resolve(getLiveTranscriptionHelper().startLiveTranscription());
      }
    });
  }
  ...
  public void stopLiveTranscription(Promise promise) {
    reactContext.getCurrentActivity().runOnUiThread(new Runnable() {
      @Override
      public void run() {
        promise.resolve(getLiveTranscriptionHelper().stopLiveTranscription());
      }
    });
  }
  ...
  public void setSpokenLanguage(int languageID, Promise promise) {
    promise.resolve(getLiveTranscriptionHelper().setSpokenLanguage(languageID));
  }
  ...
  public void setTranslationLanguage(int languageID, Promise promise) {
    promise.resolve(getLiveTranscriptionHelper().setTranslationLanguage(languageID));
  }
